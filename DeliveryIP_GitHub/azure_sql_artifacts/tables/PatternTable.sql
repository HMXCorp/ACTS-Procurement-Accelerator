...
VALUES
	...
	('Oracle', 'Number of Rows in Table', 'rowsTableCount', 'text', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Oracle', 'Oracle', 'Collects the necessary metadata required to register an Oracle Ingestion Pattern.', 1, 1, ''),
	('Oracle', 'Number of Columns in Table', 'colsTableCount', 'text', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Oracle', 'Oracle', 'Collects the necessary metadata required to register an Oracle Ingestion Pattern.', 1, 1, ''),
	('Oracle', 'LS Secret Name', 'LSSecretName', 'variable', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Oracle', 'Oracle', 'Collects the necessary metadata required to register an Oracle Ingestion Pattern.', 1, 1, 'LS_Oracle'),
	('Oracle', 'Top Level Pipeline One', 'topLevelPipelineOne', 'variable', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Oracle', 'Oracle', 'Collects the necessary metadata required to register a Oracle file Ingestion Pattern.', 1, 1, 'PL_1_Source_to_Landing_Orchestrator_Step1'),
	('Oracle', 'Top Level Pipeline Two', 'topLevelPipelineTwo', 'variable', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Oracle', 'Oracle', 'Collects the necessary metadata required to register a Oracle file Ingestion Pattern.', 1, 1, 'PL_2_Process_Landed_Files_Step2'),
	...
	('Oracle', 'Watermark Value', 'watermarkValue', 'text', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Oracle', 'Oracle', 'Collects the necessary metadata required to register a Oracle file Ingestion Pattern.', 1, 1, ''),
	...
	('Netezza', 'Is Data Partitioned?', 'partitioningOption', 'choice', 1, 'none#DataSlice', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza Ingestion Pattern.', 1, 1, ''),
	('Netezza', 'Table Name', 'tableName', 'text', 1, '', 'DataAssetTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza Ingestion Pattern.', 1, 1, ''),
	('Netezza', 'Table Schema', 'tableSchema', 'text', 1, '', 'DataAssetTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza Ingestion Pattern.', 1, 1, ''),
	('Netezza', 'Watermark Column', 'watermarkColumn', 'text', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza Ingestion Pattern.', 1, 1, ''),
	('Netezza', 'Watermark Format', 'watermarkFormat', 'choice', 1, 'DATETIME#INT#STRING', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza Ingestion Pattern.', 1, 1, ''),
	('Netezza', 'Number of Rows in Table', 'rowsTableCount', 'text', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza Ingestion Pattern.', 1, 1, ''),
	('Netezza', 'Number of Columns in Table', 'colsTableCount', 'text', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza Ingestion Pattern.', 1, 1, ''),
	('Netezza', 'LS Secret Name', 'LSSecretName', 'variable', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza Ingestion Pattern.', 1, 1, 'LS_Netezza'),
	('Netezza', 'Top Level Pipeline One', 'topLevelPipelineOne', 'variable', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza file Ingestion Pattern.', 1, 1, 'PL_1_Source_to_Landing_Orchestrator_Step1'),
	('Netezza', 'Top Level Pipeline Two', 'topLevelPipelineTwo', 'variable', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza file Ingestion Pattern.', 1, 1, 'PL_2_Process_Landed_Files_Step2'),
	('Netezza', 'Data Loading Behavior', 'dataLoadingBehavior', 'variable', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza file Ingestion Pattern.', 1, 1, 'Netezza'),
	('Netezza', 'Watermark Value', 'watermarkValue', 'text', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza file Ingestion Pattern.', 1, 1, ''),
	('Netezza', 'Source Container', 'sourceContainer', 'variable', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza file Ingestion Pattern.', 1, 1, 'landing'),
	('Netezza', 'Sink Container', 'sinkContainer', 'variable', 1, '', 'SourceTechnicalInformation', 'Handshake Pattern', 'Icon.Home', 'Netezza', 'Netezza', 'Collects the necessary metadata required to register a Netezza file Ingestion Pattern.', 1, 1, 'raw');
GO