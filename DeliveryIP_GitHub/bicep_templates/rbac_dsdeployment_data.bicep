...
module m_cognitive_service_datalake_rbac 'rbac_storage_reader.bicep' = if (DeployCognitiveService == 'True' && DeployDataLake == 'True') {
  name: 'datalake_rbac'
  params: {
...
module m_cognitive_service_landingstorage_rbac 'rbac_storage_reader.bicep' = if (DeployCognitiveService == 'True' && DeployLandingStorage == 'True') {
...
module m_adf_datalake_rbac 'rbac_datalake.bicep' = if (DeployADF == 'True' && DeployDataLake == 'True') {
...
module m_adf_landingstorage_rbac 'rbac_datalake.bicep' = if (DeployADF == 'True' && DeployLandingStorage == 'True') {
...
module m_synapse_datalake_rbac 'rbac_datalake.bicep' = if (DeploySynapse == 'True' && DeployDataLake == 'True') {
...
module m_synapse_landing_storage_rbac 'rbac_datalake.bicep' = if (DeploySynapse == 'True' && DeployLandingStorage == 'True') {
...
module m_synapse_cognitiveService_rbac 'rbac_cognitive_service_user.bicep' = if (DeployCognitiveService == 'True') {
...
module m_eventhub_landingstorage_rbac 'rbac_datalake.bicep' = if (DeployEventHubNamespace == 'True' && DeployLandingStorage == 'True') {
...
module m_stream_analytics_landing_storage_rbac 'rbac_datalake.bicep' = if (DeployLandingStorage == 'True' && DeployStreamAnalytics == 'True') {
