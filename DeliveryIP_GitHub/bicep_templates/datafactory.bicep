...
param DeployMetadataDrivenPipelinesToSynapse string
...
resource r_SelfHostedIntegrationRuntime 'Microsoft.DataFactory/factories/integrationRuntimes@2018-06-01' = if (DeployMetadataDrivenPipelinesToSynapse == 'False') {
...
resource r_LS_DataLake 'Microsoft.DataFactory/factories/linkedservices@2018-06-01' = if (DeployADFArtifacts == 'True') {
  name: 'LS_DataLake'
  parent: r_datafactory
  properties: {
    annotations: []
...
resource r_LS_LandingStorage 'Microsoft.DataFactory/factories/linkedservices@2018-06-01' = if (DeployADFArtifacts == 'True') {
...
resource r_LS_SQL_MetadataControl 'Microsoft.DataFactory/factories/linkedservices@2018-06-01' = if (DeployADFArtifacts == 'True') {
...
resource r_LS_Synapse 'Microsoft.DataFactory/factories/linkedservices@2018-06-01' = if (DeployADFArtifacts == 'True') {
  name: 'LS_Synapse'
  parent: r_datafactory
  properties: {
    annotations: []
...
resource LS_Oracle 'Microsoft.DataFactory/factories/linkedservices@2018-06-01' = if (DeployADFArtifacts == 'True') {
  name: 'LS_Oracle'
  parent: r_datafactory
  properties: {
    parameters: {
