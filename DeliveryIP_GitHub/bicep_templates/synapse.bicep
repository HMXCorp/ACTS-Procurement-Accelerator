...
output testDeployWithCustomNetworking string = DeployWithCustomNetworking

output testAllowAccessToIpRange string = AllowAccessToIpRange
...
param DeployMetadataDrivenPipelinesToSynapse string = 'False'
...
resource r_SelfHostedIntegrationRuntime 'Microsoft.Synapse/workspaces/integrationRuntimes@2021-06-01' = if (DeployMetadataDrivenPipelinesToSynapse == 'True') {
